...
In this process, we need to ingest the data, processing it to clean/transform/... it, modelling the data and
...
Now that we have an idea of what takes to carry on repetitive tasks in parallel, we can see a
*real life* example:
